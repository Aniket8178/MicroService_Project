...
import com.lcwd.HotelService.Excetion.ResourceNotFoundException;
...
public class HotelServiceImpl implements HotelService {
    ...
    public Hotel getsingle(String id) {
        return hotelRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Hotel with the given id is not present on server...!!"));
    }
}
